...
void main() {
  testWidgets('Opaque background crossfades never expose the desktop', (
    tester,
  ) async {
    ...
    await tester.pumpWidget(
      RepaintBoundary(key: canvas, child: const DaemonApp()),
    );
    ...
    for (final mode in ['texture', 'solid', 'ambient']) {
      ...
      expect(await alpha(), 255, reason: '$mode stays opaque during crossfade');
      await tester.pumpAndSettle();
    }
