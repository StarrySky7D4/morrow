fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("cargo:rerun-if-changed=schemas/tls_identity.proto");
    prost_build::Config::new()
        .protoc_executable(protoc_bin_vendored::protoc_bin_path()?)
        .compile_protos(&["schemas/tls_identity.proto"], &["schemas"])?;
    ...
    prost_build::Config::new()
        .protoc_executable(protoc_bin_vendored::protoc_bin_path()?)
        .compile_protos(&["schemas/service_authority.proto"], &["schemas"])?;
    println!("cargo:rerun-if-changed=schemas/service_config.proto");
    prost_build::Config::new()
        .protoc_executable(protoc_bin_vendored::protoc_bin_path()?)
        .compile_protos(&["schemas/service_config.proto"], &["schemas"])?;
    ...
    println!("cargo:rerun-if-changed=schemas/service_resources.capnp");
