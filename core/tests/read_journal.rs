...
fn format_ten_migration_preserves_original_content_evidence_and_signed_segment() {
    ...
    rusqlite::Connection::open(&path)
        .unwrap()
        .execute_batch("DROP TABLE read_captures; DROP TABLE operation_read_archives; DROP TABLE read_archive_parts; DROP TABLE read_archives; PRAGMA user_version=10;")
        .unwrap();
