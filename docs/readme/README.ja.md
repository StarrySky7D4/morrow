...
現在のバージョンは **0.1.9-test.55+59**。**Windows x64 向けテストプレビュー**であり、安定版ではありません。Windows ZIP、対応するソース ZIP、SHA-256 一覧をダウンロードできます。すべて展開して `morrow_studio.exe` を実行し、DLL、ホスト、`data`、`plugins`、ライセンスファイルを残してください。

[test.55 をダウンロード](https://github.com/StarrySky7D4/morrow/releases/tag/v0.1.9-test.55) · [互換テスト版 test.1](https://github.com/StarrySky7D4/morrow/releases/tag/v0.1.9-test.1)
...
- [リリースノートと検証](../../reports/0.1.9-test.55-release.md)
