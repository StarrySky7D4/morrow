...
Aktuelle Version: **0.1.9-test.54+58**, eine **Windows-x64-Testvorschau**, keine stabile Veröffentlichung. Lade das Windows-ZIP, das zugehörige Quellcode-ZIP und die SHA-256-Liste herunter. Entpacke alles und starte `morrow_studio.exe`; sämtliche DLLs, Host, `data`, `plugins` und Lizenzdateien müssen erhalten bleiben.

[test.54 herunterladen](https://github.com/StarrySky7D4/morrow/releases/tag/v0.1.9-test.54) · [Kompatible Testversion test.1](https://github.com/StarrySky7D4/morrow/releases/tag/v0.1.9-test.1)
...
- [Versionshinweise und Prüfungen](../../reports/0.1.9-test.54-release.md)
